...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] src/scripts/components/App.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/Users/tjfogarty/Projects/spotify-player/src/scripts/components/App.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: {
	    broadcastResults: function broadcastResults(results) {
	      this.$broadcast('showResults', results);
	    }
	  },

	  ready: function ready() {
	    this.$on('broadcastResults', this.broadcastResults);
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/scripts/components/Player.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/tjfogarty/Projects/spotify-player/src/scripts/components/Player.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports) {
	...
	exports.default = {
	  ...
	  methods: {
	    audioTimeUpdated: function audioTimeUpdated() {
	    ...
	    handleClick: function handleClick(item) {
	      var phoneScreen = document.querySelector('.c-phone__screen');
	      var track = this.$get('track');
	    ...
	    fetchTrack: function fetchTrack(id) {
	      ...
	      this.$http.get('https://api.spotify.com/v1/albums/' + id).then(function (response) {
	        var track = _this.$get('track');

	        if (track) {
	          track.pause();
	        }

	        var audioObject = new Audio(response.data.tracks.items[0].preview_url);

	        audioObject.play();

	        _this.$set('playing', true);

	        _this.$set('track', audioObject);
	  ...
	  ready: function ready() {
	    ...
	    this.$on('showResults', function (results) {
	      _this2.$set('albums', results);
	      _this2.$set('artistImage', results[0].images[0].url);

	      _this2.pauseTrack();
	      _this2.$set('track', null);
	    });
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/tjfogarty/Projects/spotify-player/src/scripts/components/Search.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    performSearch: function performSearch() {
	      ...
	      this.$http.get('https://api.spotify.com/v1/search', { q: term, type: 'album' }).then(function (response) {
	        if (response.status === 200 && response.data.albums.total) {
	          _this.$set('showError', false);
	          _this.$dispatch('broadcastResults', response.data.albums.items);
	        } else {
